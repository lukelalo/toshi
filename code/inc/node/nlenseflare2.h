...
//
//  Modified to uv 4 flares from 1 bitmap by Ken Melms, 01-16-02
//------------------------------------------------------------------------------

#ifndef N_NLENSEFLARE2_H
#define N_NLENSEFLARE2_H
...
//------------------------------------------------------------------------------
inline
nFlareDesc2::nFlareDesc2(): fSize(0.125f),
                          fHalfSize(fSize / 2),
                          fPosition(1.0f),
                          fRed(1.0f),
                          fGreen(1.0f),
...
//------------------------------------------------------------------------------
inline
nFlareDesc2::~nFlareDesc2() {}

//------------------------------------------------------------------------------
class N_DLLCLASS nLenseFlare2 : public nVisNode
{
public:
    nLenseFlare2();
   ~nLenseFlare2();
...
inline
int
nLenseFlare2::GetNumberOfFlares() 
{
...
inline
float
nLenseFlare2::GetFlareSizeAt(int ndx) 
{
...
inline
float
nLenseFlare2::GetFlarePosAt(int ndx) 
{
