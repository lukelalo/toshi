...
public:
    ...
    int CollectByFrustum(nGfxServer* gfx_server, MapQuadElement**&);
    int GetCollect(MapQuadElement**&);

    void Visualize(nGfxServer*);
...
private:
    ...
    void visualize_node(nGfxServer *, MapQuadNode *);
    ...
    // Frustum occlusion
    void InitClipPlanes(nGfxServer* gfx_server);
    ...
    void init_block_clip_planes(nGfxServer* gfx_server,
                                MapQuadElement* elm);
