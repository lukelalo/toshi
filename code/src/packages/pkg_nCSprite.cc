...
#else
extern "C" void N_EXPORT nCSprite_addmodules(nKernelServer *);
extern "C" void N_EXPORT nCSprite_remmodules(nKernelServer *);
void N_EXPORT nCSprite_addmodules(nKernelServer *ks)
#endif
{
...
#else
void N_EXPORT nCSprite_remmodules(nKernelServer *)
#endif
{
}
//----------------------------------------------------------
