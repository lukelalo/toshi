...
/**
    ...
    n3dnode with adjacent nmatnode and ntexnodes; setbasecolor enables the lense
    flare to be used with a mixer, useing the base color to alter the individual
    flare colors via a multiplication (see nLenseFlare2::ColorFlares(...))
*/
void
...
{
    nLenseFlare2 *self = static_cast<nLenseFlare2*>(o);
...
//------------------------------------------------------------------------------
bool
nLenseFlare2::SaveCmds(nPersistServer *fs)
{
