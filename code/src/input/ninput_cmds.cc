...
/**
    ...
    @info
    Maps an input event to an input state. The 'EventName' 
    defines an input event which controls the input state
    given via 'StateName'. The definition of an input event consists 
...
/**
    ...
    @info
    Returns the value set via 'setlongpressedtime'. 
*/
