...
static void n_rxyz(void* slf, nCmd* cmd);
static void n_txyz(void* slf, nCmd* cmd);
static void n_sxyz(void* slf, nCmd* cmd);
...
n_initcmds(nClass* clazz)
{
    ...
    clazz->AddCmd("v_rxyz_fff", 'RXYZ', n_rxyz);
	clazz->AddCmd("v_txyz_fff", 'TXYZ', n_txyz);
	clazz->AddCmd("v_sxyz_fff", 'SXYZ', n_sxyz);
